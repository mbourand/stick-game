 ...
 * The ◀ ▶ key hints sit right alongside the pills so the footer doesn't have to
 * carry them (and overflow the ring).
 */
...
const ArrowHint = ({ glyph }: { glyph: string }) => (
  <span
    className="inline-flex items-center justify-center h-5 px-1.5 rounded border border-white/30 text-[10px] font-bold text-white/50"
    aria-hidden
  >
    {glyph}
  </span>
